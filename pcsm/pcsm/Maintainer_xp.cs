...
namespace pcsm
{
    public partial class Maintainer_xp : Form
    {
        ...
        {   
            ...
            if (checkBox1.Checked == false && checkBox2.Checked == false && checkBox3.Checked == false && checkBox5.Checked == false)
            {
        ...
        private void backgroundWorker1_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            else
            {
                if (Global.currentprocess == "analysis")
                {
                    ...
                    checkBox5.Location = new System.Drawing.Point(218, 227);
